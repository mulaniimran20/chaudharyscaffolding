    ...
    width: 5em;
            ...
            <?php
                ...
                while($rr = mysqli_fetch_array($res))
                {
                    ...
                    if($olddate != $date[0])
                    {
                    $cols = $cols."<th><b>".str_replace("-","/",$date[0])."</b></th>";
                ...
                while($rr1 = mysqli_fetch_array($res1))
                {
                    ...
                    if($olddate1 != $date[0])
                    {
                    $cols1 = $cols1."<th><b>".str_replace("-","/",$date[0])."</b></th>";
...
<body>
    ...
    <div class="row invoice-box">
        <div class="col-md-3 fxied" style="margin-right:-30px;">
            ...
            <tr class="top">
                <td>
                    <table>
                        <tr>
                            <td class="title">
                                <img src="<?php echo $rowa['admin_shop_logo'];?>" style="width:80%; max-width:142px; visibility:hidden;">
                            </td>
            ...
            <tr class="information">
                <td>
                    <table id="tblData">
                        <tr>
                            <td>
                                <b style="visibility:hidden;">To:<br>
            ...
            ?>
                    ...
                    while($row = mysqli_fetch_array($resultc, MYSQLI_ASSOC))
                    {
                        ...
                        $q1 = "SELECT * FROM `new_billing_list` WHERE `billing_recipt_id` = '".$reciptid."' and `product_id` = '".$pid."' and `datedd` LIKE '".$dd."%'";
    ...
    <div class=" table-responsive col-md-9" style="overflow-x:auto;">
        <table cellpadding="0" cellspacing="0" class="table" id="tableexport">
                        <tr class="top">
                            ...
                            <td colspan="<?php echo $maincolspan-3; ?>">
                                <b><?php echo "<h2 style='color:#DA70D6'>".$rowa['admin_shop_name']."</h2><p style='font-size:12px;'>".$rowa['admin_shop_address']."<br>Email: ".$rowa['admin_email_id']." Mo.No. ".$rowa['admin_contact_no']."</p>"; ?></b>
                            </td>
            ...
            <tr class="heading">
                <td colspan="<?php echo $maincolspan; ?>">
                    <b>Note:- This Material only on Returnable basis, Not for sale</b>
                </td>
            </tr>
