  ...
  <div>
    <div class="card">
      ...
      <div class="card-body">
         ...
         <div class="form-group">
         <div class="form-label-group">
                  <input type="email" id="ccemail" name="ccemail" class="form-control" placeholder="CC Email ID" required="required">
                  <label for="ccemail">CC Email ID</label>
                </div>
                </div>
...
$('#site_name').each(function() {
    ...
    $(this).focus(function() {
        ...
        if(i == 1)
        {
            var d = $('#inputPassword').val();
            $('#inputPassword').value = $('#inputPassword').value;
        }
        else{
            $('#inputPassword').value = d;
        }
    ...
    var id = document.getElementById("addaddress").value;
        ...
        $.ajax({
                ...
                success: function(d) {
                    ...
                    $('#contactname').val(obj.contacct_person);
                                
                                $('#lastName').val(obj.user_email.trimLeft());
                                
                                $('#inputPassword1').val(obj.user_contact_no.trimLeft());
                         
                                $('#inputPassword').val(obj.user_address.trimLeft());
                             
                                $('#site_name').val(obj.site_name.trimLeft());
...
document.getElementById('datedd').valueAsDate  = new Date();
