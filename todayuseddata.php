...
<body class="bg-dark">
<form action="savebilldaily.php" method="post" id="formid">
                    ...
                    if(d.length > 2)
                    {
                        ...
                        for (i = 0; i < dataaa.length; i++) {
                            ...
                            else if(i == 1)
                            {
                                ...
                                $('#lastName').val();
                                var dscm = lastname.replace('"','');
                                $('#lastName').val(dscm.trimLeft());
                            ...
                            else if(i ==2)
                            {
                                ...
                                $('#inputPassword1').val();
                                var dscm = inputPassword1.replace('"','');
                                $('#inputPassword1').val(dscm.trimLeft());
                            ...
                            else if(i == 4)
                            {
                                ...
                                $('#inputPassword').val();
                                var dscm = inputPassword.replace('"','');
                                $('#inputPassword').val(dscm.trimLeft());
                            ...
                            else if(i == 3)
                            {
                                ...
                                var dsc = site_name.replace('"','');
                                $('#site_name').val(dsc.trimLeft());
