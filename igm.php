...
<body>
    ...
    <div class="row invoice-box">
        <div class="col-md-4 fxied" style="margin-right:-30px;">
                ...
                <td>
                    <table>
                            ...
                            <td class="title">
                                ...
                                <b style="visibility:hidden;"><div style="height:228px;"></div></b>
                    ...
                    <table id="tblData">
                        <tr>
                            <td style="height:102px;">
                                <b style='font-size:20px; visibility: hidden;'>A&nbsp;<br>
                                &nbsp;<br>
                                </b>
                            </td>
                        </tr>
    ...
    <div class=" table-responsive col-md-8" style="overflow-x:auto;">
